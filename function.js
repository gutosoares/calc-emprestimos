function calculate() {
    ...
    //Retorna uma lista de links para financeiras locais
    ...
    function chart(principal, interest, monthly, payments) {
        ...
        //Se chamamos sem argumentos ou se o navegador não suporta elementos gráficos, basta retornar
        if(arguments.length == 0 || graph.getContext) return;

        var g = graph.getContext("2d");
        var width = graph.width, height = graph.height;

        //Funções que convertem números de pagementos e valores monetários em pixels
